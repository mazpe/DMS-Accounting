...
public class TableDataMover
{
    ...
    /**
     * Both JTable below is the origin and destination table. Data is moved from
     * table_origin to table_destination
     */
    ...
    Object data_move[];
    /**
     * This object is needed to create the column for table_destination as the
    ...
    /**
     * Creates a new instance of TableDataMover with table_origin and
     * table_destination directly initialized
     */
    ...
    public void copySelectedRows()
    {
         ...
         */
        int[] selectedRows = getTable_origin().getSelectedRows();
        ...
        for (int i = 0; i < selectedRows.length; i++)
        {
            ...
            {
                data_move[j] = getTable_origin().getValueAt(selectedRows[i], j);
            }
